#NAME: your name here
# Prog Purpose: This program uses losts to find the persona property tax for vehicles
#   in Chaslottesville and produces a report which displays all data and the total tax due
#   for six months
#
